				...
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							...
							<div class="card-body">
								<form action="<?= base_url('admin_panel/ProductsCategories/EditCat'); ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label>Category Name</label>
										<input type="text" name="catName" class="form-control" value="<?= $cat['cat_name']; ?>">
									</div>
									<div class="form-group">
										<label>Select Image</label>
										<input type="file" name="cat_mg" class="dropify" data-height="100"  data-default-file="<?= base_url('uploads/cat_img/'.$cat['img']); ?>" />
